...
class PeriodicTable(tk.Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        self.topLabel = tk.Label(self, text="Click the element you would like information about.", bg = '#0C6478', font=('Papyrus',20, "bold"), fg='white')
        ...
        for b in column1:
            ...
            tk.Button(self,
                      ...
                      height=2,
                      bg=bg_color,
                      command=lambda text=b: self.name(text[1]) or self.info(text[2])
                      ).grid(row=r, column=c)
            r += 1
            if r > 7: 
                r = 1
        ...
        c = 1
        for b in column2: 
            tk.Button(self,  text=b[0],  width=5,  height=2,  bg="light salmon",  command=lambda text=b:  self.name(text[1]) & self.info(text[2])).grid(row=r, column=c)
            r += 1
            if r > 7: 
                r = 1
                c += 1
        ...
        self.fillerLine = tk.Label(self, text="",bg ='tan' )
        ...
        # Define the 'Games' button
        tk.Button(self, text="Games", width=5, height=2, bg="darkgreen", fg="white", command=self.open_game).grid(row=11, column=0)  # Place it above 'Reset'
                
        r = 12
        c = 0
        for b in reset:
            tk.Button(self, text=b[0], width=5, height=2, bg="saddlebrown", fg="white",
                    command=lambda text=b: self.name(text[1]) & self.info(text[2])).grid(row=r, column=c)
            r += 1
            if r > 7:
                r = 1
